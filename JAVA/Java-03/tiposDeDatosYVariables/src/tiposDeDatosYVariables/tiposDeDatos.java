...
public class tiposDeDatos {
    ...
    public static void main(String[] args) {
        ...
        byte horasTrabajadas = 8; //horas trabajadas
        byte pago = 10;
        int multiplicacionB = horasTrabajadas * pago;
        System.out.println("Las horas trabajadas son: " + multiplicacionB);
        
        double num = 1.61;
        int numInt = (int)num; //Aqui estamos diciendo que se cambie a entero
        long numLong = (long)num; //Aqui lo estamos cambiando a long
...
*/
            ...
            System.out.println("Residuo Moadulo: " + mod);
            
            //Ejercicio 2
            // Declara 2 variables de tipo boolean y utiliza el operador ==
            
            boolean boolle1 = false;
            boolean boolle2 = true;
            System.out.println(boolle1 == boolle2);
            ...
            double nume4 = 5.55;
            double nume5 = 11.11;
            System.out.println(nume4 < nume5);
            
            //Ejercicio Farenheit - Celcius y Kelvin
            
            double FCenti = 36.5;
            double CCenti = (FCenti -32)*5/9;
            double KCenti = FCenti + 273.15;

            System.out.println("El Resultado en CELCIUS es: " + CCenti);

            System.out.println("El Resultado en KELVIN es: " + KCenti);
            ...
            if (elPepe%2==0) {
                System.out.println("El número no tiene residuo plebe");
            }else {
                System.out.println("El número si tiene residuo ajua: " + (elPepe%2));
            }
