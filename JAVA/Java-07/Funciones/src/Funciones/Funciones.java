...
public class Funciones { //clase llamada Funciones
    ...
    public static double calcularAltura(double distancia, double anguloElevacion) {
        ...
        // Retornar la altura de la torre
        return altura;
        }
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("El ángulo de elevación es: " + Math.toDegrees(angulo) + " grados");
                ...
                // Imprimir los datos
                System.out.println("Distancia a la torre: " + distancia + " metros");
                System.out.println("Ángulo de elevación: " + anguloElevacion + " grados");
